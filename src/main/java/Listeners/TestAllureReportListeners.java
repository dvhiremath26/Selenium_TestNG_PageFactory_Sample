...
public class TestAllureReportListeners implements ITestListener {   
	...
	public void onFinish(ITestContext iTestContext) {
		//System.out.println("I am in onFinish method " + iTestContext.getName());
		 IResultMap passedTests = iTestContext.getPassedTests();
	        ...
	        //driverFactory.sendSMSTestReport(summary);
	       // driverFactory.sendWATestReport(summary);      
	        
//	        System.out.println("LambdaTestTest Summary:\n" 
//	        		+ "Passed: " + passedCount +"\n"
//	        		+"Failed: " + failedCount );
	}
